...
\begin{itemize}
    ...
    \item \textbf{The number of supported signatures}. The construction supports up to 226 (SHRINCS-B) and 418(SHRINCS-L) stateful signatures and up to $2^{20}$ stateless signatures, which should be enough for wallets. 
\end{itemize}
