...
\begin{enumerate}
    ...
    \item Stateful vs. Stateless tradeoff: Stateful schemes (XMSS) offer small signatures but require careful state management. Stateless schemes (SPHINCS+) are robust but produce large signatures.
