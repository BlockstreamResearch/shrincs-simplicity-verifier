...
\begin{itemize}
    \item Using size-efficient stateful signatures ($\approx 300$ bytes for $q=1$) during normal operation (SHRINCS-B).
    \item Using verification-efficient stateful signatures ($\approx 50$ hashes for $q=1$) during normal operation (SHRINCS-L).
