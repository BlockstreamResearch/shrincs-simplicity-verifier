...
\subsubsection{FORS Authentication path}
\begin{verbatim}
...
\subsection{The Stateless Fallback}
\subsubsection{Parameters}
...
\begin{tabular}{ c c }
 Parameter & SHRINCS-SHA2-128s \\ 
 \hline
 \texttt{hsl} & 63 (total tree height)\\
 \texttt{d} & 5 (number of hypertree layers) \\
 \texttt{h'} & 8 (height per layer) \\
 \texttt{a} & 22 (FORS tree height) \\
 \texttt{k} & 6 (number of FORS trees) \\
 \texttt{w} & 256 \\
 \texttt{n} & 16 \\
\end{tabular}
\end{center}
