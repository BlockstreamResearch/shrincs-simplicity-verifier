\section{Overview}
\mknote{I wonder if we should include guidlince for state management here. Maybe this: https://datatracker.ietf.org/doc/draft-ietf-pquip-hbs-state/02/ can be useful. But maybe it is not for this document. Maybe it is better to update our HB paper with these discussions.}
...
The size of the secret key is \texttt{6n} bytes. A public key consists of two values \texttt{PK ← (PK.seed, PK.root)} and has a size of \texttt{2n} bytes.\mknote{bits, bot bytes}
