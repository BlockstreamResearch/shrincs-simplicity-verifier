...
\begin{verbatim}
    ...
    15. for layer from 0 to d - 1:
        ...
        c. xmss_sig ← xmss_sign(msg, SK.seed, SK.prf, PK.seed, PK.root, ADRS, h_prime, leaf_idx[layer])
        d. ht_sig ← ht_sig || xmss_sig
        e. if layer < d - 1:
            msg ← xmss_root(SK.seed, PK.seed, ADRS, h_prime)
...
\begin{verbatim}
    ...
    7. for layer from 0 to d - 1:
        ...
        b. idx ← idx >> h_prime
        c. tree_idx[layer] ← idx AND (2^(h_sl - (layer + 1) * h_prime) - 1)
