...
\mknote{Should we have a unified API for these functions with similar logic: xmss treehash(SK.seed, PK.seed, ADRS, target height, start idx)
Is level the target hash that is output? If Lvl is 1 what do we output: WOTSpk or rightsubtree.}
\begin{verbatim}
