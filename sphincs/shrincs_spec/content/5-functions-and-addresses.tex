...
\paragraph{Note.} For SHA-256, the compression function operates on 64-byte blocks. Since \texttt{PK.seed || ADRS} is 16 + 32 = 48 bytes, we pad it to 64 bytes to optimize performance:
