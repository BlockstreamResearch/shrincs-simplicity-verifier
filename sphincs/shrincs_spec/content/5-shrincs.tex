...
\begin{itemize}
    ...
    \item[] \texttt{words}: (12 bytes) type-dependent 12 bytes (Appendix~B)
\end{itemize}
...
\subsection{WOTS+C. The Stateful Leaf}
...
For SHRINCS-SHA2-128s, we use the Winternitz parameter $w=256$. This means each chain processes 8 
