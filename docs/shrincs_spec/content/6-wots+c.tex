...
\begin{verbatim}
    Algorithm: wots_grind(PK.seed, digest, ADRS)
    Input:
        PK.seed: public seed
...
\begin{verbatim}
    Algorithm: wots_digest(PK.seed, digest, ctr, ADRS)
    Input:
    ...
    1. setTypeAndClear(ADRS, WOTS_GRIND)
    2. grind_out ← H_grind(ADRS, PK.seed, digest, ctr)
...
\begin{verbatim}
    ...
    4. (msg, ctr) ← wots_grind(PK.seed, digest, ADRS)
    5. sig ← R || ctr
...
\begin{verbatim}
    ...
    4. if is_internal:
            ...
            setTypeAndClear(ADRS, H_MSG)
            digest ← H_msg(ADRS, R, PK.seed, PK.root, m)
    5. (msg, valid) ← wots_digest(PK.seed, digest, ctr, ADRS)
    6. if not valid:
        return false
    7. tmp ← []
