...
Signature size calculation: 
\mknote{We don't need to include the counter for the FORS, since it is used inside the PRF and the Randomness is resampled. We just include the final sampling of the random value. The counter is hidden from the verifier.}
\begin{verbatim}
